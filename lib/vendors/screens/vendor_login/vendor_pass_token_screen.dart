...
import 'package:caterfy/vendors/screens/vendor_login/vendor_reset_pass_screen.dart';
import 'package:flutter/material.dart';
import 'package:pinput/pinput.dart';
import 'package:provider/provider.dart';
import 'package:toastification/toastification.dart';

class VendorPassTokenScreen extends StatefulWidget {
  final String email;
  const VendorPassTokenScreen({super.key, required this.email});

  @override
  State<VendorPassTokenScreen> createState() => _VendorPassTokenScreenState();
}

class _VendorPassTokenScreenState extends State<VendorPassTokenScreen> {
  String token = '';
                      ...
                      onCompleted: (pin) async {
                        ...
                        if (!success && context.mounted) {
                          ...
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => VendorResetPassScreen(),
                            ),
                          );
                        }
                      },
