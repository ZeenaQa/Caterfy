...
class VendorResetPassScreen extends StatefulWidget {
  const VendorResetPassScreen({super.key});

  @override
  State<VendorResetPassScreen> createState() => _VendorResetPassScreenState();
}

class _VendorResetPassScreenState extends State<VendorResetPassScreen> {
  String password = '';
  String confirmPass = '';
